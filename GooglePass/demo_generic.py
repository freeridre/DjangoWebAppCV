...
class DemoGeneric:
    ...
    def __init__(self):
        self.key_file_path = settings.GOOGLE_APPLICATION_CREDENTIALS
    ...
    def create_jwt_new_objects(self, issuer_id: str, class_suffix: str,
        ...
        new_object = {
            ...
            "cardTitle": {
                "defaultValue": {
                    'language': 'en-US',
                    'value': 'Senity Security Systems'
                }
            },
            "header": {
                "defaultValue": {
                    "language": "en-US",
                    "value": "Rozmaring street 5."
                }
            },
            "subheader": {
                "defaultValue": {
            ...
            "logo": {
                "sourceUri": {
                    "uri": 'https://senitysecuritysystems.com/static/images/passes/google/logo.png',
                },
                "contentDescription": {
                    "defaultValue": {
                        "language": "en-US",
            ...
            "hexBackgroundColor": "#2d2f31",
            "id": f'{issuer_id}.{object_suffix}',
            "classId": f'{issuer_id}.{class_suffix}',
            "smartTapRedemptionValue": "Daniel Pal",
            'state': 'ACTIVE',
            "passConstraints": {
        ...
        logger.debug(f"[DEBUG]: claims: {claims}")
    ...
    @staticmethod
    def create_jwt_private_generic_pass(issuer_id: str, key_file_path: str, object_suffix: str,
                               user_name: str, pay_load: str, date_time: str) -> str:
        ...
        USER_ID = "daniel.pal@senitysecuritysystems.com"

        # OBJECT_ID - Developer-defined ID for the pass
        OBJECT_ID = object_suffix
        ...
        ###############################################################################
        # Create a JWT for the generic private pass, and encode it to create a "Save" URL.
        ###############################################################################

        claims = {
            "aud": "google",
            "payload": {
                "genericPrivatePasses": [
                    {
                        "header": {
                            "defaultValue": {
                            "language": "en-US",
                        ...
                        "heroImage": {
                            "sourceUri": {
                            "uri": "https://senitysecuritysystems.com/static/images/passes/google/hero.png",
                            },
                            "contentDescription": {
                                "defaultValue": {
                                    "language": "en-US",
            ...
            "iss": f"{SERVICE_ACCOUNT}",
            "origins": [
                "https://senitysecuritysystems.com"
            ],
            "typ": "savetowallet"
        }
        ...
        logger.debug(f"[DEBUG]: save_url: {save_url}")
        return save_url
